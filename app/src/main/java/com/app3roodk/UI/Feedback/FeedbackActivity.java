...
public class FeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.feedback_container, mFragment)
                    .commit();
        }
    }
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.action_add_offers:
                                ...
                                if (UtilityGeneral.getNumberOfAvailableOffers(getBaseContext(), UtilityGeneral.getCurrentYearAndWeek()) <= 0) {
                                    ...
                                    startActivityForResult(new Intent(FeedbackActivity.this, AddNewOfferActivity.class), 222);
                                return true;
                            ...
                            case R.id.action_new_shop:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(FeedbackActivity.this, ShopActivity.class), 222);
                                return true;

                            case R.id.action_home:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(FeedbackActivity.this, CategoriesActivity.class), 222);
                                return true;

                            case R.id.action_view_my_shop:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(FeedbackActivity.this, ListShopsActivity.class), 222);
                                return true;

                            case R.id.action_logout:
                                AuthUI.getInstance()
                                        .signOut(FeedbackActivity.this)
                            ...
                            case R.id.action_favorites:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(FeedbackActivity.this, FavoritesActivity.class), 222);
                                return true;
                            ...
                            case R.id.action_aboutapp:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(FeedbackActivity.this, AboutActivity.class), 222);
                                return true;
    ...
    private void hideDrawerItems() {
        ...
        nav_Menu.findItem(R.id.action_feedback).setChecked(true);
