...
public class ListShopsActivity extends AppCompatActivity {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.action_add_offers:
                                ...
                                if (UtilityGeneral.getNumberOfAvailableOffers(getBaseContext(), UtilityGeneral.getCurrentYearAndWeek()) <= 0) {
                                    ...
                                    startActivityForResult(new Intent(ListShopsActivity.this, AddNewOfferActivity.class), 222);
                                return true;
                            ...
                            case R.id.action_new_shop:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(ListShopsActivity.this, ShopActivity.class), 222);
                                return true;
                            ...
                            case R.id.action_logout:
                                AuthUI.getInstance()
                                        .signOut(ListShopsActivity.this)
                            ...
                            case R.id.action_favorites:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(ListShopsActivity.this, FavoritesActivity.class), 222);
                                return true;

                            case R.id.action_feedback:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(ListShopsActivity.this, FeedbackActivity.class), 222);
                                return true;

                            case R.id.action_aboutapp:
                                mDrawerLayout.closeDrawer(GravityCompat.END);
                                startActivityForResult(new Intent(ListShopsActivity.this, AboutActivity.class), 222);
                                return true;
    ...
    private void hideDrawerItems() {
        ...
        nav_Menu.findItem(R.id.action_view_my_shop).setChecked(true);
                            ...
                            .into(new BitmapImageViewTarget((ImageView) mNavigationView.findViewById(R.id.imgNavProfile)) {
                                ...
                                protected void setResource(Bitmap resource) {
                                    RoundedBitmapDrawable circularBitmapDrawable =
                                            RoundedBitmapDrawableFactory.create(ListShopsActivity.this.getResources(), resource);
