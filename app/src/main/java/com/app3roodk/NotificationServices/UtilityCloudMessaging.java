...
public class UtilityCloudMessaging {
    ...
    static public void sendNotification(Context context, String sendToToken, String title, String body,
                                        String tag, HashMap<String, String> data, String clickAction
